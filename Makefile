...
IMPLS = ada ada.2 awk bash basic bbc-basic c chuck clojure coffee common-lisp cpp crystal cs d dart dmk \
	elisp elixir elm erlang es6 factor fantom forth fsharp go groovy gnu-smalltalk \
	guile haskell haxe hy immer io java js jq julia kotlin livescript logo lua make mal \
...
immer_STEP_TO_PROG =         impls/immer/$($(1))
